...
;function appViewModel(){function e(){l=new google.maps.LatLng(42.3581,-71.0636),u=new google.maps.Map(document.getElementById("map-canvas"),{center:l,zoom:14,disableDefaultUI:!0}),n()}function n(){h.allPlaces([]);var e={location:l,radius:500,types:["food","bar","cafe"]};d=new google.maps.InfoWindow,service=new google.maps.places.PlacesService(u),service.nearbySearch(e,o)}function o(e,n){n===google.maps.places.PlacesServiceStatus.OK&&(p=new google.maps.LatLngBounds,e.forEach(function(e){e.marker=t(e),e.instagrams=ko.observableArray([]),e.isGettingInstagrams=ko.observable(!0),e.isInFilteredList=ko.observable(!0),h.allPlaces.push(e),r(e),p.extend(new google.maps.LatLng(e.geometry.location.lat(),e.geometry.location.lng()))}),u.fitBounds(p))}function t(e){var n=new google.maps.Marker({map:u,position:e.geometry.location});return google.maps.event.addListener(n,"click",function(){document.getElementById(e.id).scrollIntoView(),$("#"+e.id).trigger("click")}),n}function a(e){var n=e.indexOf(","),o=e.slice(0,n)+".";return o}function s(e){var n=e.indexOf(","),o=e.slice(n+1);return o=o.replace(", United States","")}function i(){var e=new Date,n=e.getDay();return 0===n?n=6:n-=1,n}function c(){$(window).height()<$(window).width()?h.photoDimensionValue($(window).height()-160):h.photoDimensionValue(.9*$(window).width())}function r(e){function n(n){var o,t=[],a=e.name.toLowerCase().replace(/[^\w]/gi,"");return n.data.forEach(function(e){o=e.name.toLowerCase().replace(/[^\w]/gi,""),(-1!==a.indexOf(o)||-1!==o.indexOf(a))&&t.push(e.id)}),t}function o(n){var o=$.Deferred();return $.ajax({type:"GET",dataType:"jsonp",cache:!1,url:n,success:function(n){n.data.forEach(function(n){e.instagrams.push(n)}),o.resolve()}}),o.promise()}function t(t){var i=n(t),c=[];i.forEach(function(e){var n="https://api.instagram.com/v1/locations/"+e+"/media/recent?access_token="+s;c.push(o(n))}),$.when.apply($,c).then(function(){clearTimeout(a),e.instagrams().sort(function(e,n){return e.likes.count>n.likes.count?-1:e.likes.count<n.likes.count?1:0}),e.isGettingInstagrams(!1)})}var a=setTimeout(function(){e.isGettingInstagrams(!1)},5e3),s="1582950873.10c5b95.cbfb0efc6d0d4242aec054371dfa8afe",i="https://api.instagram.com/v1/locations/search?lat="+e.geometry.location.lat()+"&lng="+e.geometry.location.lng()+"&distance=50&access_token="+s,c=$.ajax({type:"GET",dataType:"jsonp",cache:!1,url:i});c.then(function(e){t(e)})}var l,u,d,p,h=this,g={0:"Monday",1:"Tuesday",2:"Wednesday",3:"Thursday",4:"Friday",5:"Saturday",6:"Sunday"};h.allPlaces=ko.observableArray([]),h.filteredPlaces=ko.computed(function(){return h.allPlaces().filter(function(e){return e.isInFilteredList()})}),h.chosenPlace=ko.observable(),h.query=ko.observable(""),h.searchTerms=ko.computed(function(){return h.query().toLowerCase().split(" ")}),h.search=function(){h.chosenPlace(null),d.setMap(null),h.allPlaces().forEach(function(e){e.isInFilteredList(!1),e.marker.setMap(null)}),h.searchTerms().forEach(function(e){h.allPlaces().forEach(function(n){(-1!==n.name.toLowerCase().indexOf(e)||-1!==n.types.indexOf(e))&&(n.isInFilteredList(!0),n.marker.setMap(u))})})},h.selectPlace=function(e){e===h.chosenPlace()?h.displayInfo(e):(h.filteredPlaces().forEach(function(e){e.marker.setAnimation(null)}),h.chosenPlace(e),h.chosenPhotoIndex(0),e.marker.setAnimation(google.maps.Animation.BOUNCE),h.displayInfo(e))},h.displayingList=ko.observable(!0),h.listToggleIcon=ko.computed(function(){return h.displayingList()?"fa fa-minus-square fa-2x fa-inverse":"fa fa-plus-square fa-2x fa-inverse"}),h.toggleListDisplay=function(){h.displayingList()?h.displayingList(!1):h.displayingList(!0),console.log(h.listToggleWidth())},h.displayInfo=function(e){var n={placeId:e.place_id};service.getDetails(n,function(n,o){var t="<h4>"+e.name+"</h4>",c="",r="",l="",p="";if(o==google.maps.places.PlacesServiceStatus.OK){n.website&&(t='<h4><a target="_blank" href='+n.website+">"+e.name+"</a></h4>"),n.formatted_phone_number&&(l="<p>"+n.formatted_phone_number+"</p>"),n.formatted_address&&(c="<p>"+a(n.formatted_address)+"</p>",r="<p>"+s(n.formatted_address)+"<p>");var h=i();n.opening_hours&&n.opening_hours.weekday_text&&(openHours=n.opening_hours.weekday_text[h],openHours=openHours.replace(g[h]+":","Today's Hours:"),p="<p>"+openHours+"</p>")}var f='<div class="infowindow">'+t+c+r+l+p+"</div>";d.setContent(f),d.open(u,e.marker),u.panTo(e.marker.position)})},h.viewingPhotos=ko.observable(!1),h.togglePhotoDisplay=function(){h.viewingPhotos()?(h.viewingPhotos(!1),u.setOptions({draggable:!0})):(h.viewingPhotos(!0),u.setOptions({draggable:!1})),c()},h.chosenPhotoIndex=ko.observable(0),h.chosenPhotoViewableIndex=ko.computed(function(){return h.chosenPhotoIndex()+1}),h.chosenPhoto=ko.computed(function(){return h.chosenPlace()?h.chosenPlace().instagrams()[h.chosenPhotoIndex()]:null}),h.captionText=ko.computed(function(){return h.chosenPhoto()&&h.chosenPhoto().caption?h.chosenPhoto().caption.text:"No Caption"}),h.captionOpacity=ko.observable(1),h.toggleCaption=function(){1===h.captionOpacity()?h.captionOpacity(0):h.captionOpacity(1)},h.nextPhoto=function(){h.chosenPhotoIndex()!==h.chosenPlace().instagrams().length-1?h.chosenPhotoIndex(h.chosenPhotoIndex()+1):h.chosenPhotoIndex(0)},h.prevPhoto=function(){0!==h.chosenPhotoIndex()?h.chosenPhotoIndex(h.chosenPhotoIndex()-1):h.chosenPhotoIndex(h.chosenPlace().instagrams().length-1)},h.photoDimensionValue=ko.observable(),h.photoDimension=ko.computed(function(){return h.photoDimensionValue()+"px"}),h.getInstagramStatus=ko.computed(function(){if(h.chosenPlace()){if(0!=h.chosenPlace().instagrams().length&&!h.chosenPlace().isGettingInstagrams())return"Click to view recent Instagrams from "+h.chosenPlace().name;if(h.chosenPlace().isGettingInstagrams())return"Retrieving Instagrams from "+h.chosenPlace().name+" ...";if(0===h.chosenPlace().instagrams().length&&!h.chosenPlace().isGettingInstagrams())return"No Instagrams found from "+h.chosenPlace().name}return""}),e(),window.addEventListener("resize",function(){u.fitBounds(p),c()}),document.addEventListener("keyup",function(e){h.viewingPhotos()&&(37===e.keyCode&&$(".previous-photo").click(),39===e.keyCode&&$(".next-photo").click())}),google.maps.event.addListener(d,"closeclick",function(){h.chosenPlace().marker.setAnimation(null),h.chosenPlace(null)}),$(function(){650>$(window).width()&&h.displayingList()&&h.displayingList(!1)}())}ko.applyBindings(new appViewModel);